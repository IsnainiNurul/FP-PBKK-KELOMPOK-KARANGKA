    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-info">
          ...
          <a href="/dashboard/admin/kategori" class="small-box-footer">Lihat Semua <i class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-info">
            ...
            <a href="/dashboard/admin/forum" class="small-box-footer">Lihat Semua <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-6">
