...
class IndexController extends Controller
{
    ...
    {    
        ...
        $tawaran = $this->db->query("SELECT * FROM  tawaran WHERE status != 'Deal' AND usernamepemilik = '".$this->session->get('user-name')."'")->fetchAll();
        $forum = $this->db->query("SELECT * FROM  forum WHERE username = '".$this->session->get('user-name')."'")->fetchAll();
